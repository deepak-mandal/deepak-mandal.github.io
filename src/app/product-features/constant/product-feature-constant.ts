...
export const PROFILE = {
    ...
    CGI_IITG: "Product Technical Analyst, Edgeverve (Infosys Finacle) | Former Sr. Software Engineer, CGI | B.Tech, IIT Guwahati",
...
export const SKILLS = {
    ...
    VS_CODE_LOGO: 'assets/images/vs_code.png',
    INTILIJ_IDEA: 'IntelliJ IDEA',
    INTILIJ_IDEA_LOGO: 'assets/images/intellij.png',
    BITBUCKET: 'Bitbucket',
    BITBUCKET_LOGO: 'assets/images/bitbucket.jpg',
    JIRA: 'Jira',
    JIRA_LOGO: 'assets/images/jira.png',
    CONFLUENCE: 'Confluence',
    CONFLUENCE_LOGO: 'assets/images/confluence.png',
    POSTMAN: 'Postman',
    POSTMAN_LOGO: 'assets/images/postman.png',
    TOMCAT: 'Tomcat',
    TOMCAT_LOGO: 'assets/images/tomcat.png',
    SWAGGER: 'Swagger',
    SWAGGER_LOGO: 'assets/images/swagger.png',
    WILDFLY: 'Wildfly',
    WILDFLY_LOGO: 'assets/images/wildfly.png',
    CLAMAV: 'ClamAV',
    CLAMAV_LOGO: 'assets/images/clamav.png',
    SOLR: 'Apache Solr',
    SOLR_LOGO: 'assets/images/solr.png',
    NGINX: 'Nginx',
    NGINX_LOGO: 'assets/images/nginx.jpg',
    SERVICE_WRAPPER: ' Apache service wrapper',
    SERVICE_WRAPPER_LOGO: 'assets/images/service-wrapper.jpg',
    LODASH: 'Lodash',
    LODASH_LOGO: 'assets/images/lodash.png',
    MAVEN: 'Maven',
    MAVEN_LOGO: 'assets/images/maven.png',
    CI_CD: 'CI/CD',
    CI_CD_LOGO: 'assets/images/cicd.png',
    ...
    ANALYTICAL_TOOLS: 'Machine Learning',
    PANDAS: 'Pandas',
    ...
    LLD_HLD_LOGO: 'assets/images/data-flow.png',
    LLD_HLD: 'System Design (HLD, LLD)',
    DS_ALGO_LOGO: 'assets/images/hierarchical.png',
    OS: 'Operating system',
    LINUX: 'Linux',
